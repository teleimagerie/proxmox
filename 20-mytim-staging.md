...
| Ressources | 2 vCPU `host`, 8 Go (sans ballooning), **150 Go** Ceph `vm-storage` (100 à la création, étendu le 15/09), `onboot` — **sur pve4 (GRA3) depuis le 15/09/2026** (migrée à chaud, 121 ms) | idem, 100 Go, **sur pve5** (20 ms) |
