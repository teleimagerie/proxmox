...
| [21-vaultwarden.md](21-vaultwarden.md) | **Coffre de mots de passe Vaultwarden** (VM 105, `vault.teleimagerie.net`) : 📋 dossier de déploiement préparé le 18/09 — SSO Keycloak obligatoire (OIDC, Google Workspace via le broker existant, pas de SAML), runbook complet, vhost et scripts prêts |
