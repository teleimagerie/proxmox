...
| [20-mytim.md](20-mytim.md) | **MyTIM (application de gestion)** : migration VPS → VM 103 (staging) puis 104 (prod) — 🚧 plan validé le 31/08, mesures faites, VM à créer ; TLS sur proxy-tim, base prod laissée chez OVH, un seul `scheduler_worker` à la fois |
