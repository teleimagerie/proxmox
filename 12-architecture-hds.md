...
| **Vue PACS → MyTIM / MyISOTEAM** (événement « étude reçue ») | `192.168.101.52` (IP publique `77.158.128.112`) | `app.teleimagerie.net`, `app.isoteam.mn` (VPS OVH) | TCP `443` | public, direct par la passerelle `.62` | ✅ HTTPS vérifié le 11/09/2026 (HTTP 200 depuis le PACS) ; règles Info Router à poser, endpoint livré côté `gestion` ([13-tellis.md](13-tellis.md#notification-des-nouvelles-études-vers-mytim--relevé-du-11092026)) |
