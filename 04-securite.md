...
- `unattended-upgrades` est **absent**. Keycloak est une application Java qui
  ...
  trois. Voir [15-keycloak.md](15-keycloak.md#4-durcissement-du-conteneur--à-faire).
...
| Clé API + secret Mailjet (SMTP Keycloak) | **gestionnaire de secrets** | copie opérationnelle dans la config du realm `tim` (base Keycloak) depuis le 30/08/2026 ; transit par pve1 détruit après test — [16-keycloak.md](16-keycloak.md#e-mail-sortant--smtp-mailjet-en-place-depuis-le-30082026) |
